...
namespace Proyecto_Final
{
    public partial class productos : Form
    {
        ...
        {
            MySqlConnection conexion = new MySqlConnection("Server=localhost; PORT=3306; database=mibodega; User Id=root; Password="); //solo cambiar el nombre de la base de datos
            conexion.Open();
